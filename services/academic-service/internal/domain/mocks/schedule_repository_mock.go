...
// Source: internal/domain/repository/schedule_repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/domain/repository/schedule_repository.go -destination=internal/domain/mocks/schedule_repository_mock.go -package=mocks
//
